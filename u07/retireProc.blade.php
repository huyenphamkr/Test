...
@push('scripts')
    <script src="{{ asset('js/users/u07.js?v=') }}"></script>
@endpush
...
<div class="edit-content">
                ...
                <table class="table tablegray table-bordered table-border-color">
                    ...
                    <tbody id="">
                        ...
                        <tr class="align-middle text-center">
                            ...
                            <td class="text-center w-c-50 border-0 border-bottom border-top border-white">
                                @if($mode == "Upd" && $statusRetire === CommonConst::U07_STATUS_HD)
    ...
    <div class="row mb-2">
        ...
        <div class="col-xl-3 col-md-4 m-3">        
            <a type="button" class="btn btn-blue {{$ButtonVissible}}" href="{{route('u072.showMemo',['id'=>$user ? $user->id : '' ])}}">詳細</a>
